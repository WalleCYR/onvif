...
import (
	...
	goonvif "github.com/WalleCYR/onvif"
	"github.com/WalleCYR/onvif/device"
	sdk "github.com/WalleCYR/onvif/sdk/device"
...
func main() {
	...
	if err != nil {
		...
		// You could use https://github.com/WalleCYR/onvif/gosoap for pretty printing response
